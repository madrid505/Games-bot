    ...
    if cmd in ["راتب", "كنز", "بخشيش", "حظ"]:
        ...
        db.update({'balance': u_data['balance'] + net_amt}, User.id == u_id)
            ...
            "راتب": (
                ...
                "━━━━━━━━━━━━━━\n"
                "📜 **الـبـيـان:** إيـداع الـراتـب الـدوري\n"
                f"💵 **الـمـبلـغ:** `{base_amt:,}` د\n"
                "⚖️ **الـضـريبة:** `-{tax_amt:,}` د\n"
                "────────────────\n"
            ...
            "كنز": (
                "🏦 **【 كـشـف حـسـاب الـبـنـك 】**\n"
                "━━━━━━━━━━━━━━\n"
                "💎 **الـبـيـان:** تـحـويـل مـن كـنـز مـدفـون\n"
            ...
            "حظ": (
                "🏦 **【 كـشـف حـسـاب الـبـنـك 】**\n"
                "━━━━━━━━━━━━━━\n"
                "🎲 **الـبـيـان:** أربـاح مـن صـندوق الـحـظ\n"
