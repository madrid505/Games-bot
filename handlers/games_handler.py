...
def get_main_menu_keyboard():
    keyboard = [[InlineKeyboardButton("🕋 إسلاميات", callback_data="g_إسلاميات"), InlineKeyboardButton("💡 ثقافة عامة", callback_data="g_ثقافة عامة")],
...
async def handle_game_logic(update: Update, context: ContextTypes.DEFAULT_TYPE, text: str):
    ...
    if text in QUESTIONS:
        ...
        return True
    # فحص الإجابة
    correct = context.chat_data.get('game_ans')
